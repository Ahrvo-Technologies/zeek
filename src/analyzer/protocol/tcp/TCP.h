...
namespace zeek::packet_analysis::TCP { class TCPAnalyzerAdapter; }
...
using TCP_Analyzer [[deprecated("Remove in v5.1. Use zeek::packet_analysis::TCP::TCPAnalyzerAdapter.")]] =
	packet_analysis::TCP::TCPAnalyzerAdapter;
...
public:
	...
	packet_analysis::TCP::TCPAnalyzerAdapter* TCP();

	void SetTCP(packet_analysis::TCP::TCPAnalyzerAdapter* arg_tcp)	{ tcp = arg_tcp; }
...
public:
	...
	// These are passed on from TCPAnalyzerAdapter.
	virtual void EndpointEOF(bool is_orig)	{ }
