...
namespace zeek {
namespace packet_analysis::TCP { class TCPAnalyzerAdapter; }
...
using TCP_Analyzer [[deprecated("Remove in v5.1. Use zeek::packet_analysis::TCP::TCPAnalyzerAdapter.")]] =
	zeek::packet_analysis::TCP::TCPAnalyzerAdapter;
...
public:
	...
	TCP_Reassembler(analyzer::Analyzer* arg_dst_analyzer,
	                packet_analysis::TCP::TCPAnalyzerAdapter* arg_tcp_analyzer,
	...
	packet_analysis::TCP::TCPAnalyzerAdapter* GetTCPAnalyzer()	{ return tcp_analyzer; }
	...
	// deliver for this endpoint.  Calls TCPAnalyzerAdapter::EndpointEOF()
	// when so.
	void CheckEOF();
...
private:
	...
	packet_analysis::TCP::TCPAnalyzerAdapter* tcp_analyzer;
