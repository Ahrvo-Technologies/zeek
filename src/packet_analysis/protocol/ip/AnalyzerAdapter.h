 ...
 */
class AnalyzerAdapter : public analyzer::Analyzer {

public:

	AnalyzerAdapter(const char* name, Connection* conn)
	 ...
	 * the constructor due to the way that AnalyzerAdapter gets instantiated.
	 *
